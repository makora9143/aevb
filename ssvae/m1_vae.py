...
class M1_VAE(Base_VAE):
    ...
    def fit(self, x_datas):
        ...
        learning_process = {'normal': self.optimize, 'early_stopping': self.early_stopping}
        self.hist = learning_process[self.hyper_params['learning_process']](
            X,
            x_datas,
    ...
    def optimize(self, X, x_datas, optimize_params, cost, updates, rng, D_KL, recon_error):
    ...
    def early_stopping(self, X, x_datas, optimize_params, cost, updates, rng, D_KL, recon_error):
